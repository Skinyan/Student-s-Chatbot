...
INSERT INTO `chatbot_hints` (`id`, `question`, `reply`)
VALUES (
    2,
    'How are you ?',
    'I am not good. How can I help you?'
  ),
  (
    3,
  ...
  (
    6,
    'Bye||See you later||Have a Good Day||tata',
    'Sad to see you are going. Have a nice day'
  ),
  (
    8,
    'who developed you|| who created you || who own you',
    'I am developed/created by Aarav. I am Here to help you with your queries.  '
  ),
  (
    10,
    'I want to ask about professors of first year.',
    'Professors of GEU are amazing.\r\nI m listing names of few\r\nchemistry-Arunima nayak mam\'\r\nfirst year b'
  );
-- --------------------------------------------------------
--
...
INSERT INTO `invalid` (`id`, `messages`)
VALUES (1, 'dijh'),
  (2, 'dijh'),
  (3, 'dijh'),
  (4, 'sd'),
...
INSERT INTO `message` (`id`, `message`, `added_on`, `type`)
VALUES (
    130,
  ...
  (
    132,
    'Sorry not be able to understand you',
    '2020-10-13 07:37:13',
    'bot'
  ),
  ...
  (
    225,
    'dsfglkdtlhjsfdhmy drgiumhdifhirdh[yfdjiuhdfiujuytdkhdukfdihufdgkh hurdfmhildlidfguh;iujfd ortiyuh dhdfrtioh mpr hgmrt uhpimthbmur',
    '2020-10-13 08:22:53',
    'user'
  ),
  (
